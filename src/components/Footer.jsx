...
import BlackLogo from "../assets/logo-inline-black.png"
...
function Footer() {
  ...
  return (
      <section className="overflow-hidden bg-white w-full fixed bottom-0 border-t">
        <div className="container relative z-10 mx-auto p-2">
          <div className="-m-8 flex flex-wrap items-center justify-between">
            <div className="w-auto p-8">
              <img src={BlackLogo} alt="" className="w-40 h-10 object-cover"/>
            </div>
            {location.pathname !== "/contact" ? 
            <>
              <div className="inline-flex space-x-8">
                {loginStatus ? <>
                  <NavLink to="/about" className={`mx-1`}>About us</NavLink>
                  <NavLink to="/contact" className={`mx-1`}>Contact us</NavLink>
                </> : <span>Made with &hearts; by Harsh Priye</span>}
              </div>
            </>:
            <>
              <ul className="m-5 flex flex-wrap items-center">
                ...
                <span className='font-medium text-gray-600'>
                  Call us at: <span className="text-black">+91 8745946064</span>
                </span>
                </li>
                <li className='p-5'>
                  <span className='font-medium text-gray-600'>
                    Email: <span className="text-black">harsh.rzf@gmail.com</span>
                  </span>
                </li>
              </ul>
            </>}
